  ...
  <table className="border-separate border border-slate-400 w-auto">
    <thead>
      <tr>
        ...
        <th className="border-separate border border-slate-300 w-3/8 h-20 bg-gray-600 text-gray-200">Content</th>
        ...
        <th className="border-separate border border-slate-300 w-3/8 h-20 bg-gray-600 text-gray-200">CommentsAmount</th>
        <th className="border-separate border border-slate-300 w-1/6 h-20 bg-gray-600 text-gray-200">actions</th>
      </tr>
    </thead>
    <tbody>
      {props.posts.map((post) => (
        <AdminEachPost post={post} key={post.id} />
      )
      )}
    </tbody>
  </table>
